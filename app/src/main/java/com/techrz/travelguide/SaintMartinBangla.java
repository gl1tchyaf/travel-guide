...
public class SaintMartinBangla extends AppCompatActivity {
    MyDatabaseHealper myDatabaseHealper;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_saint_martin_bangla);
        ...
        slideModels.add(new SlideModel(R.drawable.coxa,""));
        slideModels.add(new SlideModel(R.drawable.coxb,""));
